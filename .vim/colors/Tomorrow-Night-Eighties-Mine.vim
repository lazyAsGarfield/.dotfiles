...
let s:darker_background = "2a2a2a"
...
let g:colors_name = "Tomorrow-Night-Eighties-Mine"
...
if has("gui_running") || &t_Co == 88 || &t_Co == 256
	...
	call <SID>X("Title", s:comment, "", "bold,italic")
	call <SID>X("Identifier", s:red, "", "none")
	call <SID>X("Statement", s:green, "", "")
	...
	" GitGutter
	call <SID>X("GitGutterAdd", s:green, "", "bold")
	call <SID>X("GitGutterChange", s:blue, "", "bold")
	...
	if has("spell")
			...
			call <SID>X("SpellCap", s:background, s:orange, "underline")
